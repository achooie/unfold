 ...
 * @author akitaya
 */
public class MainDeveloperFrameSVG1 extends javax.swing.JFrame {
    ...
    public MainDeveloperFrameSVG1() {
        ...
        mouseListenerFoldedFrame = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                mainView.copy((CanvasSVG1) jPanelCurrentStep.getComponent(0));
                setMainView((CanvasSVG1) e.getSource());
                if (((CanvasSVG1) e.getSource()).getParent().equals(jPanelNextStep)) {
    ...
    public void setMainView(CanvasSVG1 screen) {
        mainView = screen;
        ((CanvasSVG1) jPanelCurrentStep.getComponent(0)).copy(screen);
    ...
    public void setNextSteps() {
        ...
        CanvasSVG1 mainView =
                ((CanvasSVG1) jPanelPreviousStep.getComponent(jPanelPreviousStep.getComponentCount() - 1));
        ...
        for (int i = 0; i < previousSteps.size(); i++) {
            ...
            CanvasSVG1 a;
            try {
                a = new CanvasSVG1(executionNode, false,
...
//        ORIPA.doc = mainView.oriDoc;
    ...
    public void setPrevSteps() {
        CanvasSVG1 a = ((CanvasSVG1) jPanelCurrentStep.getComponent(0)).copy(150, 150);
        a.setPreferredSize(new Dimension(150, 150));
        a.addMouseListener(mouseListenerFoldedFrame);
        mainView = a;
...
//            unfolder.getPrevious(currentStep);
            try {
                CanvasSVG1 firstStep = new CanvasSVG1(currentStep, false, "", jCheckBoxFlip.isSelected(), 600, 600);
    ...
    private void jCheckBoxFlipActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxFlipActionPerformed
        ((CanvasSVG1) jPanelCurrentStep.getComponent(0)).flipFaces(jCheckBoxFlip.isSelected());
...
//        }
    ...
    private void jButtonClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonClearActionPerformed
        ((CanvasSVG1) jPanelCurrentStep.getComponent(0)).clearSymbols();
    ...
    private void jToggleButtonSelectKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jToggleButtonSelectKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_DELETE
            ...
            ((CanvasSVG1) jPanelCurrentStep.getComponent(0)).deleteSelectedSymbol();
        }
    ...
    private void jToggleButtonSelectFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jToggleButtonSelectFocusLost
        ((CanvasSVG1) jPanelCurrentStep.getComponent(0)).unSelected();
    ...
    private void jCheckBoxShowCPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxShowCPActionPerformed
        ...
        if (jCheckBoxShowCP.isSelected()) {
            CanvasSVG1 currentCanvas = (CanvasSVG1) jPanelCurrentStep.getComponent(0);
            ...
            CanvasSVG1 screen = ((CPScreenSVG) jPanelCurrentStep.getComponent(0)).currentCanvas;
            jPanelCurrentStep.removeAll();
            jPanelCurrentStep.add(screen);
    ...
    private void jButtonPrevFoldedFormActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrevFoldedFormActionPerformed
        ...
        ((CanvasSVG1) jPanelCurrentStep.getComponent(0)).redrawOrigami();
...
//        if (isViewingNextStep) {
        currentStep = ((CanvasSVG1) jPanelCurrentStep.getComponent(0)).step;
        choosedSequence.add(currentStep);
        setPrevSteps();
        setNextSteps();
//        }
    ...
    private void jButtonDeleteLastStepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteLastStepActionPerformed
        if (choosedSequence.size() > 1) {
            ...
            setMainView((CanvasSVG1) jPanelPreviousStep.getComponent(jPanelPreviousStep.getComponentCount() - 1));
            setNextSteps();
            jPanelPreviousStep.repaint();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainDeveloperFrameSVG1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new MainDeveloperFrameSVG1().setVisible(true);
            }
        });
    }
