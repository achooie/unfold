 ...
 * @author akitaya
 */
public class CanvasSVG1 extends JSVGCanvas
...
//    ArrayList<ArrayList<FaceRegion>> faceLayers;
    ...
    public CanvasSVG1(int width, int height) {
        super();
    ...
    public CanvasSVG1(ExecutionNode execNode, boolean isMainView, String description,
        ...
        setDisableInteractions(true);
        po = new Point2D.Double(15, 15);
        oriDoc = GeomUtilD.foldCP(step.stepCp);

        diagram = new Diagram(oriDoc, po);
//        buildFaces();
...
//        System.out.println("setup " + this.hashCode());
    ...
    public void copy(CanvasSVG1 screen) {
...
//        this.faceLayers = screen.faceLayers;
        ...
        this.diagram = screen.diagram;
        setUpDocument();
    }

    public CanvasSVG1 copy(int width, int height) {
        CanvasSVG1 c = new CanvasSVG1(width, height);
        c.oriDoc = oriDoc;
        c.step = step;
...
//        c.setUpDocument();
    ...
    public void setDiagramNotation(CanvasSVG1 mainView) {
        CP nextStep = mainView.step.stepCp;
        //crease lines 

        diagram.addFoldLines(nextStep);
...
//        }
        ...
        diagram.addFoldArrow(mainView.oriDoc);
    }
//
...
//    private boolean isTopFace(FaceRegion faceRegionCandidate, ArrayList<FaceRegion> faces) {
...
//    private ArrayList<FaceRegion> above(FaceRegion faceRegionCandidate, ArrayList<FaceRegion> faces) {
...
//        Element svgRoot = document.getDocumentElement();       
        ...
        updateTransform();
        diagram.buildSVGDoc(document);
        diagram.addFaces(rotationGroup, isFlipped);
//        if (!isFlipped) {
